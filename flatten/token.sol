...
// File @pefish/solidity-lib/contracts/contract/erc20/Erc20Base.sol@v0.1.19
...
// File contracts/token/pbc.sol

pragma solidity ^0.8.0;


contract PBC is Erc20Base, Ownable {
    ...
    constructor(
        ...
        Erc20Base.__Erc20Base_init(_initialSupply, _name, _symbol, 18);
    }
